...
# Stock-GenEval DiffusionNFT + privileged-prompt distillation (PPD) launcher.
# Operating procedure (see guidance/storage_and_training.md and the PPD
# section of guidance/algorithms.md):
#
...
#   ./scripts/train_nft_geneval_stock_ppd.sh   # auxiliary arm (rho=60)
#
...
export CONFIG="${CONFIG:-examples/nft/lora/sd3_5/geneval_stock_ppd.yaml}"
...
flowfactory_require_env RUNTIME_ROOT
if [[ ! -f "${RUNTIME_ROOT}/data/geneval_stock_ppd_pairs/records.jsonl" ]]; then
  printf 'error: %s\n' \
